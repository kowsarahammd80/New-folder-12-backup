  ...
  const handleSocial = () => {
    ...
    providerLogIn(provider)
      .then(result => {
        ...
        //  fetch(`https://car-sell-buy-server-kowsarahammd80.vercel.app/registerData/${user?.email}`,{
        //    method: 'POST',
        //    headers :{
        ...
        fetch(`https://car-sell-buy-server-kowsarahammd80.vercel.app/socialLogin/${user?.email}`)
          .then((res) => res.json())
